...
public class MyContactsAdaptor extends RecyclerView.Adapter {
    ...
    public MyContactsAdaptor(ArrayList<User> userArrayList, User userDetails, OnItemClickListener onItemClickListener) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.sendMessage:
                    mListener.onSendMessage(userArrayList.get(getBindingAdapterPosition()));
                    break;

                case R.id.videoCall:
                    mListener.onVideoCall(userArrayList.get(getBindingAdapterPosition()));
                    break;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.myeachcontactview,parent,false);
